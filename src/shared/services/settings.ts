...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    {
      name: 'creem_moderation',
      title: t('groups.creem_moderation'),
      description: `Custom <a href="https://docs.creem.io/features/moderation" class="text-primary" target="_blank">Creem Moderation</a> settings`,
      tab: 'ai',
    },
    {
      name: 'replicate',
...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      placeholder:
        'Happy Horse AI is an AI video generation platform for creating cinematic videos from text, images, and reference media.',
      type: 'textarea',
      group: 'appinfo',
      tab: 'general',
    },
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'Happy Horse AI <no-reply@happyhorse-ai.app>',
      group: 'resend',
      tab: 'email',
    },
    {
    ...
    },
    {
      ...
      title: 'Creem Moderation Enabled',
      type: 'switch',
      value: 'false',
      group: 'creem_moderation',
      tab: 'ai',
      tip: 'Screen AI generation prompts with Creem before credits, task creation, or provider calls.',
    },
    {
      name: 'creem_moderation_api_base',
      title: 'Creem Moderation API Base',
      type: 'url',
      value: 'https://api.creem.io',
      placeholder: 'https://api.creem.io',
      group: 'creem_moderation',
      tab: 'ai',
      tip: 'Use https://test-api.creem.io for sandbox keys and https://api.creem.io for production keys.',
    },
    {
      name: 'creem_moderation_api_key',
      title: 'Creem Moderation API Key',
      type: 'password',
      placeholder: 'creem_xxx',
      group: 'creem_moderation',
      tab: 'ai',
    ...
    {
      name: 'creem_moderation_block_flag',
      title: 'Block Flagged Prompts',
      type: 'switch',
      value: 'true',
      group: 'creem_moderation',
      tab: 'ai',
      tip: 'When enabled, Creem flag decisions are blocked like deny decisions. When disabled, flagged prompts are logged and allowed.',
    },
    {
      name: 'creem_moderation_timeout_ms',
      title: 'Creem Moderation Timeout',
      type: 'number',
      value: '5000',
      placeholder: '5000',
      group: 'creem_moderation',
      tab: 'ai',
      tip: 'Timeout in milliseconds. Failures are blocked to keep generation fail-closed.',
    },
    {
    ...
    },
    {
      ...
      type: 'password',
      placeholder: 'apimart_xxx',
      group: 'apimart',
      tip: 'APIMart API Key is used to access the HappyHorse 1.0 video model',
      tab: 'ai',
    },
    {
    ...
    },
    {
      ...
      group: 'apimart',
      tab: 'ai',
      tip: 'Use custom storage to save generated HappyHorse videos before APIMart URLs expire',
    },
    {
      name: 'adsense_code',
      title: 'Adsense Code',
