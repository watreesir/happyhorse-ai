...
description: Privacy policy for Happy Horse AI Video Generator
created_at: 2025-10-24
---

## Introduction

Welcome to Happy Horse AI Video Generator, an AI-powered platform for generating cinema-quality videos. At Happy Horse AI Video Generator, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using Happy Horse AI Video Generator:
...
2. **Usage Details**
   - **What We Collect**: Information about how you use Happy Horse AI Video Generator, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access Happy Horse AI Video Generator, such as device type, operating system, and browser type.
...
**Copyright Owner**: [happyhorse-ai.app](https://happyhorse-ai.app)
**Email**: [support@happyhorse-ai.app](mailto:support@happyhorse-ai.app)

By using Happy Horse AI Video Generator, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
